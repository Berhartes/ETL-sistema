/**
 * 🚀 Despesas de Deputados v2 (Clean Architecture)
 *
 ...
 * 
 * Reduzido de 128 linhas → ~80 linhas (Enterprise-Ready)
 */

import { DespesasDeputadosV2Processor } from '../processors/despesasdeputadosv2processor.processor.js';
 ...
 */
function setupCLI() {
  return createStandardETLParser('camara:despesasdeputados_v2', 'Despesas de Deputados v2')
