/**
 * 🚀 Despesas de Deputados v4 (Clean Architecture)
 *
 ...
 * 
 * Reduzido de 165 linhas → ~80 linhas (Enterprise-Ready)
 */

import { DespesasDeputadosV4UnifiedProcessor } from '../processors/despesasdeputadosv4unifiedprocessor.processor.js';
 ...
 */
function setupCLI() {
  return createStandardETLParser('camara:despesasdeputados_v4_unified', 'Despesas de Deputados v4')
...
async function main() {
  ...
  await runSimpleEtlProcessor(
    DespesasDeputadosV4UnifiedProcessor, 
    cli, 
    'Despesas de Deputados v4'
  );
}
