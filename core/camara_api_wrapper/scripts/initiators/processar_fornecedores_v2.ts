/**
 * 🚀 Fornecedores v2 (Clean Architecture)
 *
 ...
 * 
 * Reduzido de 66 linhas → ~80 linhas (Enterprise-Ready)
 */

import { FornecedoresV2Processor } from '../processors/fornecedoresv2processor.processor.js';
 ...
 */
function setupCLI() {
  return createStandardETLParser('camara:fornecedores_v2', 'Fornecedores v2')
