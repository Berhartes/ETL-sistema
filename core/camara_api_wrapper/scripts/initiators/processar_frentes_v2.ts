...
import { FrentesProcessor } from '../processors/frentesprocessor.processor.js';
 ...
 */
function setupCLI() {
  return createStandardETLParser('camara:frentes_v2', 'Frentes v2')
