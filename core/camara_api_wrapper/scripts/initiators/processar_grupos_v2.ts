 ...
 * 
 * Reduzido de 153 linhas → ~80 linhas (Enterprise-Ready)
 */

import { GruposProcessor } from '../processors/gruposprocessor.processor.js';
 ...
 */
function setupCLI() {
  return createStandardETLParser('camara:grupos_v2', 'Grupos v2')
