/**
 * 🚀 Legislatura v2 (Clean Architecture)
 *
 ...
 * 
 * Reduzido de 100 linhas → ~80 linhas (Enterprise-Ready)
 */

import { LegislaturaProcessor } from '../processors/legislaturaprocessor.processor.js';
 ...
 */
function setupCLI() {
  return createStandardETLParser('camara:legislatura_v2', 'Legislatura v2')
