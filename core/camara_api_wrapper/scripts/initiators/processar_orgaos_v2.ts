 ...
 * 
 * Reduzido de 177 linhas → ~80 linhas (Enterprise-Ready)
 */

import { OrgaosProcessor } from '../processors/orgaosprocessor.processor.js';
 ...
 */
function setupCLI() {
  return createStandardETLParser('camara:orgaos_v2', 'Órgãos v2')
