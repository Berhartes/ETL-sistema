/**
 * 🚀 Partidos v2 (Clean Architecture)
 *
 ...
 * 
 * Reduzido de 61 linhas → ~80 linhas (Enterprise-Ready)
 */

import { PartidosProcessor } from '../processors/partidosprocessor.processor.js';
 ...
 */
function setupCLI() {
  return createStandardETLParser('camara:partidos_v2', 'Partidos v2')
