/**
 * 🚀 Perfil de Deputados v2 (Clean Architecture)
 *
 ...
 * 
 * Reduzido de 197 linhas → ~80 linhas (Enterprise-Ready)
 */

import { PerfilDeputadosProcessor } from '../processors/perfildeputadosprocessor.processor.js';
 ...
 */
function setupCLI() {
  return createStandardETLParser('camara:perfildeputados_v2', 'Perfil de Deputados v2')
